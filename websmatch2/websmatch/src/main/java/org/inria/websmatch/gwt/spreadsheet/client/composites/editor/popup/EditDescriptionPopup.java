...
public class EditDescriptionPopup extends PopupPanel {

    public EditDescriptionPopup(final SimpleCell cell) {
	super(false);
	...
	textArea.setText(cell.getEditedDescription());
	textArea.setAlignment(TextAlignment.JUSTIFY);
	textArea.setTitle("Edit the cell description");
	...
	finishButton.addClickHandler(new ClickHandler() {
		public void onClick(ClickEvent event) {
		    cell.setEditedDescription(textArea.getText());
		    hide();
		}
	});
