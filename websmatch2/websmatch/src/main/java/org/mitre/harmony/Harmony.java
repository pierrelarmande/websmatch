...
public class Harmony extends JFrame implements ProjectListener, WindowListener
{
     ...
     * 
     */
    private static final long serialVersionUID = 5030998224570062034L;

	/** Stores the Harmony model */
	private HarmonyModel harmonyModel;
	
	public static boolean yamDB = false;
	...
	static public void main(String args[])
	{
		...
		try {
			...
			// Added config for insert YAM results in DB
			yamDB = new Boolean(ConfigManager.getParm("preferences.insertResInDB"));
			//
